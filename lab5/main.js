function createAuthorElement(record) { //создание авторского элемента
...
function createUpvotesElement(record) { //создание кнопки "лайк"
...
function createFooterElement(record) { //создание ячейки, содержащую автора и "лайки"
...
function createContentElement(record) { //создание ячейки, содержащую факт
...
function createPageBtn(page, classes = []) { //кнопка создания страницы
...
function downloadData(page = 1, qParam = "") { //функция загрузки информации
    let factsList = document.querySelector('.facts-list');
